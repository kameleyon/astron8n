...
import { Settings, History, FileText, LogOut, User } from "lucide-react";
    ...
    <header className="bg-[#0d0630] text-white py-3 relative z-50">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 items-center text-sm">
          ...
          <span className="text-gray-500">|</span>
          <a href="#prices" className="hover:text-white/80 transition-colors">Prices</a>
          <span className="text-gray-500">|</span>
          <a href="#apikeys" className="hover:text-white/80 transition-colors">API</a>
        </div>
