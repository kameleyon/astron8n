...
export function AspectsSection({ aspects }: AspectsSectionProps) {
  ...
  const minorAspects: AspectDisplay[] = [
    { symbol: "⚼", aspect: "Saturn Sesquiquadrate Chiron", orb: 0, color: "text-[#645b4b]" },
    { symbol: "∠", aspect: "Saturn Octile North Node", orb: 0, color: "text-[#645b4b]" },
    { symbol: "⚸", aspect: "Saturn Septile Uranus", orb: 0, color: "text-[#645b4b]" },
    { symbol: "⚸", aspect: "Venus Quintile MC", orb: 0, color: "text-[#645b4b]" },
    { symbol: "⚺", aspect: "Venus Semi-sextile Saturn", orb: 1, color: "text-[#645b4b]" },
    { symbol: "⚺", aspect: "Moon Semi-sextile Venus", orb: 1, color: "text-[#645b4b]" },
    { symbol: "⚼", aspect: "Moon Sesquiquadrate Chiron", orb: 2, color: "text-[#645b4b]" },
    { symbol: "⚻", aspect: "Uranus Quincunx MC", orb: 2, color: "text-[#645b4b]" },
    { symbol: "∠", aspect: "Sun Octile Mars", orb: 2, color: "text-[#645b4b]" },
    { symbol: "⚼", aspect: "Moon Sesquiquadrate Chiron", orb: 2, color: "text-[#645b4b]" },
    { symbol: "∠", aspect: "Moon Octile Venus", orb: 2, color: "text-[#645b4b]" },
    { symbol: "⚸", aspect: "Sun Quintile Mars", orb: 3, color: "text-[#645b4b]" },
    { symbol: "∠", aspect: "Venus Octile Pluto", orb: 3, color: "text-[#645b4b]" },
    { symbol: "⚺", aspect: "Chiron Semi-sextile MC", orb: 4, color: "text-[#645b4b]" }
  ]
        ...
        <div className="space-y-2">
          {leftColumn.map((aspect, index) => (
            <div key={index} className="flex items-center space-x-2">
              <span className={`text-lg leading-none ${aspect.color || 'text-[#645b4b]'}`}>
                {aspect.symbol}
              </span>
              <span className="text-sm">{aspect.aspect}</span>
              <span className="text-xs text-[#645b4b]">orb: {aspect.orb}°</span>
            </div>
          ))}
        </div>
      ...
      <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[#645b4b] dark:text-gray-300">Sextile</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-lg text-orange-500">☍</span>
            <span className="text-[#645b4b] dark:text-gray-300">Opposition</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-lg text-[#645b4b]">⚺</span>
            <span className="text-[#645b4b] dark:text-gray-300">Semi-sextile</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-lg text-[#645b4b]">⚼</span>
            <span className="text-[#645b4b] dark:text-gray-300">Sesquiquadrate</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-lg text-[#645b4b]">⚸</span>
            <span className="text-[#645b4b] dark:text-gray-300">Quintile</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-lg text-[#645b4b]">∠</span>
            <span className="text-[#645b4b] dark:text-gray-300">Octile</span>
          </div>
        </div>
      </div>
    </motion.div>
