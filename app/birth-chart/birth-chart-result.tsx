        ...
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <motion.h1 
              ...
              className="text-lg md:text-2xl font-futura mb-1"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4">
              <div className="shadow-md shadow-black/20 rounded-xl bg-white/5">
                <div className="p-6">
                  <h2 className="text-lg font-futura mb-2">Your Cosmic Blueprint</h2>
                  {loading ? (
          ...
          {/* Planets and Houses */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 dark:bg-[#ffffff]/5 mb-8 shadow-md shadow-black/20 rounded-xl p-4">
            {/* Planets */}
            <div>
              <div className="p-6">
